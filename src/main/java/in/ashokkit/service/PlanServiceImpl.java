...
import in.ashokkit.repo.PlanCategoryRepo;
import in.ashokkit.repo.PlanRepo;
...
public class PlanServiceImpl implements PlanService {
	...
	public boolean savePlan(Plan plan) {
		...
		//1 way
		/*
		 * if(saved.getPlan()!=null) { return true; }else { return false; }
		 */
